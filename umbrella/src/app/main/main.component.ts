...
export class MainComponent implements OnInit {
  ...
  public isEditingLocation: boolean = true;

  constructor(private http: HttpClient) { }

  ngAfterViewInit() {
    //remove o foco dos botões após a animação
    document.querySelectorAll('.edit-location, .details').forEach(button => {
  ...
  updateLocation() {
    ...
    // Adicione aqui a lógica para atualizar a localização, se necessário
  }
